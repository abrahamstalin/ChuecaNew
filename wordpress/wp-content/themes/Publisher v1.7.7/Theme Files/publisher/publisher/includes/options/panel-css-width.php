...
if ( ! function_exists( 'publisher_cb_css_generator_columns_space' ) ) {
	...
	function publisher_cb_css_generator_columns_space( &$block = array(), &$value = '' ) {
		...
		$block[10] = array(
			...
			'prop'     =>
				array(
					'margin-bottom' => _themename_width_changer_to_px( $space_1_6 > 20 ? $space_1_6 - 20 : 0, 'px', '!important' ),
				),
		);
		...
		$block[11] = array(
			'selector' =>
				array(
					...
					9  => '.betteradscontainer.adloc-post-before-author',
