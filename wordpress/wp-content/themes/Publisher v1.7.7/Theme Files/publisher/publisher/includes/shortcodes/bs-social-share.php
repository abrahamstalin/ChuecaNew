...
if ( ! function_exists( 'publisher_shortcode_social_share_get_li' ) ) {
	...
	function publisher_shortcode_social_share_get_li( $id = '', $show_title = TRUE, $count_label = 0 ) {
		...
		if ( is_null( $initialized ) ) {
			$cur_page       = bf_social_share_guss_current_page();
...
if ( ! function_exists( 'publisher_social_share_option_list' ) ) {
	...
	function publisher_social_share_option_list() {
		return array(
			...
			'line'        => array(
				'label'     => '<i class="fa fa-line-it"></i> ' . __( 'LINE (Only Mobiles)', 'publisher' ),
				'css-class' => 'active-item'
			),
			'bbm'         => array(
				'label'     => '<i class="fa fa-bbm"></i> ' . __( 'BlackBerry BBM (Only Mobiles)', 'publisher' ),
				'css-class' => 'active-item'
			),
			'viber'       => array(
				'label'     => '<i class="fa fa-viber"></i> ' . __( 'Viber (Only Mobiles)', 'publisher' ),
				'css-class' => 'active-item'
			),
