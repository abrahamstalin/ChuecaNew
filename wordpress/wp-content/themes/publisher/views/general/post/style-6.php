...
<div class="content-wrap">
	<main <?php publisher_attr( 'content', '' ); ?>>
		...
		<div class="container <?php echo $layout_setting['container']; // escaped before ?> post-template-6">

			<div class="post-header post-tp-6-header" style="background-image: url(<?php echo $img['src']; ?>);">
				<?php
