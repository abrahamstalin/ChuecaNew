		...
		<script type="text/html" id="tmpl-bgs-gallery-setting">
			...
			<label class="setting">
				...
				<select data-setting="bgs_gallery_image_size">
					<option value=""><?php esc_html_e( 'Themename - Large', 'publisher' ); ?></option>
					<option value="small"><?php esc_html_e( 'Themename - Small', 'publisher' ); ?></option>
	...
	function extend_gallery_shortcode( $output = '', $atts, $content = FALSE, $tag = FALSE ) {
		...
		if ( ! is_feed() && isset( $atts['bgs_gallery_type'] ) && $atts['bgs_gallery_type'] == 'slider' ) {
			...
			foreach ( $image_ids as $key => $image_id ) {
				...
				$image = $this->get_attachment_full_info( $image_id, $image_size );
