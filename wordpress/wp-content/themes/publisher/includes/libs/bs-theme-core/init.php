...
class Publisher_Theme_Core {
	...
	/**
	 * Init 'version-compatibility' section
	 * Versions compatibility manager
	 */
	function version_compatibility() {
		if ( ! defined( 'DOING_AJAX' ) || ! DOING_AJAX ) {
			include self::get_dir_path() . 'version-compatibility/class-publisher-theme-version-compatibility.php';
		}
	}
